...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name', 'email', 'password', 'remember_token','persona_id','estado','nombreCompleto'];
    ...
    */
    ...
    {
        return $this->hasOne('App\Core\Entities\Solicitudes\Empleados', 'identificacion', 'persona_id');
    }
